...
/*
	 ...
	 */
	$aColumns = array( 'Player', 'Position', 'Eligibility', 'OBP', 'SLG', 'RHR', 'RBI', 'HR', 'SBC', 'Rank', 'Total');

  $whereClauses = array();

  $whereClauses[] = "SourceData = 2011";

  if (isset($_GET['pos'])) {
    $positions = getOpenPositionsFromDraftLineup(getMyTeamID());
...
//  $sWhere = "WHERE SourceData = 2011 AND Position = 'C'";
