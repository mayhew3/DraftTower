<?php
  ...
  $sql = "SELECT * FROM BieberBatComparison";
  $rs = query($sql);
?>
           ...
           <td>
               <table>
                   <tr valign="middle">
                       ...
                       <td class="bordered"><?=$row['BieberBatting1']?></td>
                       <td class="bordered"><?=$row['ShangBatting1']?></td>
                   ...
                   <tr>
                       ...
                       <td class="bordered"><?=$row['BieberBatting2']?></td>
                       <td class="bordered"><?=$row['ShangBatting2']?></td>
                   </tr>
               </table>
           </td>
       </tr>
