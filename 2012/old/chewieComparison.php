<?php
  ...
  $sql = "SELECT * FROM ChewieComparison";
  $rs = query($sql);
?>
           ...
           <td>
               <table>
                   <tr valign="middle">
                       ...
                       <td class="bordered"><?=$row['FPTS1']?></td>
                       <td class="bordered"><?=$row['Roto1']?></td>
                       <td rowspan="2" valign="middle" class="bordered"><?=0-$row['Diff1']*$row['Diff2']?></td>
                   ...
                   <tr>
                       ...
                       <td class="bordered"><?=$row['FPTS2']?></td>
                       <td class="bordered"><?=$row['Roto2']?></td>
                   </tr>
               </table>
           </td>
       </tr>
