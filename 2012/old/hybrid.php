<?php
  ...
  $sql = "SELECT * FROM BieberComparison";
  $rs = query($sql);
?>
           ...
           <td>
               <table>
                   <tr valign="middle">
                       ...
                       <td class="bordered"><?=$row['Bieber1']?></td>
                       <td class="bordered"><?=$row['Shang1']?></td>
                   ...
                   <tr>
                       ...
                       <td class="bordered"><?=$row['Bieber2']?></td>
                       <td class="bordered"><?=$row['Shang2']?></td>
                   </tr>
               </table>
           </td>
       </tr>
